...
from sciencebeam_pipelines.pipelines import metypeset_pipeline as metypeset_pipeline_module
from sciencebeam_pipelines.pipelines.metypeset_pipeline import PIPELINE
