...
from sciencebeam_pipelines.pipelines import contentmine_pipeline as contentmine_pipeline_module
from sciencebeam_pipelines.pipelines.contentmine_pipeline import PIPELINE
